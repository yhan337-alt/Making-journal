...
In this new system, participants first place their hand inside the Black Box and explore a range of tactile surfaces with different textures. (Participants who do not relate to this experience are also able to pass through the installation without engaging in the interaction.) These materials are designed to act as sensory triggers. This encourages participants to recall the moment when they wanted to speak but remained silent. (discomfort, tension, hesitation). After engaging with the tactile experience, participants reflect on their own experience of silence and select the category that most closely matches that moment. They are then given a corresponding bead, which is placed into the transparent accumulation system. Through this process, each participant becomes a single data point, and each bead functions as encoded data representing a specific experience of silence.
